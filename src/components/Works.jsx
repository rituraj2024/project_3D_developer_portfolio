...
//               className="black-gradient w-10 h-10 rounded-full flex justify-center items-center mx-1 cursor-pointer"
//             >
//               <img
//                 src={github}
//                 alt="source code"
  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      <Tilt
        ...
        className="bg-tertiary p-5 rounded-2xl sm:w-full"
      >
        <div className="relative w-full h-[230px]">
          <img
            src={image}
...
const Works = () => {
  return (
    <>
      <motion.div variants={textVariant()}>
        <p className={`${styles.sectionSubText} text-xl`}>My work</p>
        <h2 className={`${styles.sectionHeadText} text-4xl`}>Projects</h2>
      </motion.div>

      <div className="w-full flex flex-col sm:flex-row">
        <motion.p
          variants={fadeIn("", "", 0.1, 1)}
          className="mt-3 text-secondary text-base sm:text-lg max-w-3xl leading-[30px]"
        >
